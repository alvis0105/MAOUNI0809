	...
	<div class="middleplace" style="display:flex;">
			...
			<div class="col-md-2">
			     <div class="list-group mt-3" style="position:absolute;width:85%;text-align:center;padding: 0px 10px;margin-left:20px;font-weight:600">
                    ...
                    <div style="cursor:pointer;" title="您已在狗狗專區的頁面摟!" class="list-group-item list-group-item-action active">狗狗專區</div>
			...
			<div class="col-md-10" style="height:auto;">				
				...
				<div class="DDM" style="margin-top:80px;">
					<div class="SearchSorting">				    
					    <div style="width:935px;margin-right:30px;">
					    	<p style="color:#424242;font-size:25px;font-weight:600;margin-top:25px;margin-right:830px;">狗狗專區<hr></p>
					    </div>
					</div>
				</div>
				...
				<c:if test="${itemVO.itemPetType == '狗'}">
